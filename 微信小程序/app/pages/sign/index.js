...
Page({
  ...
  */
  updateTask: function (openId) {
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/plan_all',
      data: {
        'openId': openId
      },
      method: 'GET', 
  ...
  //定时函数
  timing: function (access_data) {
    
    var myVar = setInterval(function () { myTimer() }, 1000);
    function myTimer() {
      var d = new Date();
      if (d.getHours() == '23' && d.getMinutes()=='00'){
        wx.request({
          url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/timing',
          data: {
            data:access_data
          },
          header: {
