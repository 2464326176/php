...
Page({
  data: {
    ...
    aleave: 0,        //全员请假的人数
    absent: 0,        //全员未打卡的人数
    aStartDay: '2018-03-05',     //任务开始时间
    aEndDay: '2018-03-08',       //任务结束时间
    aRecordList: [],
    sontime: 0,       //个人准时签到的人数
    slate: 0,         //个人到签到的人数
    sleave: 0,        //个人请假的人数
    sbsent: 0,        //个人未打卡的人数
    sStartDay: '2018-03-06',     //个人开始时间
    sEndDay: '2018-03-08',       //个人结束时间
    sLateList: [],
    sLeaveList: [],
    sAbsentList: [],
    sOntimeList: [],
  ...
  changeTab: function (e) {
    ...
    if (id == 'all') {
      ...
      // this.getAllTotal(d.taskID, '2018-03-04', '2018-03-05');
      // 请求当天全体详细记录
  ...
  changeSTab: function (e) {
    ...
    this.getSingleRecord(d.openId, d.taskID, d.sStartDay, d.sEndDay, id);
  ...
  aStartDateChange: function (e) {
    ...
    this.getAllTotal(d.taskID, d.aStartDay, d.aEndDay);
    this.getAllRecord(d.taskID, d.aStartDay, d.aEndDay);
  },
  ...
  getAllTotal: function (taskID, startDay, endDay) {
    console.log(taskID, startDay, endDay);
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/getinfo/getAll?type=daily&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
  ...
  getAllRecord: function (taskID, startDay, endDay) {
    var that = this;
     wx.request({
       url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/getinfo/getAll?type=all&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET', 
      success: function(res){
        // success
        console.log(res)
  ...
  getSingleTotal: function (openId, taskID, startDay, endDay) {
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/Getinfo/getSing?type=individual&detail=simple&openId=' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
      success: function(res){
        // success
        var d = res.data.data;
  ...
  getSingleRecord: function (openId, taskID, startDay, endDay, detail) {
    ...
    console.log(detail)
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/Getinfo/getSing?type=all&openId=' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay + '&detail=' + detail,
      method: 'GET',
      success: function(res){
        // success
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      // taskStartDate: util.getYMD(now),
      // taskEndDate: util.getYMD(now),
      currentTime: util.getYMD(now) + ' ' + util.getHM(now) + ' ' + util.getW(now),
      // sStartDay: util.getYMD(now),
      // sEndDay: util.getYMD(now),
    })
    //初始化个人统计日期
    this.setData({
      sStartDay: util.getYMD(now),
