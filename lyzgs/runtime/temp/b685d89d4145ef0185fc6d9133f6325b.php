<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\public/../application/index\view\index\testpaper.html";i:1517018931;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<header>
    <img src="HOME_IMG/rpw_back_n.png">
    <span>填写企业信息</span>
    <div class="clear"></div>
</header>
<section class="logo-license">
    <div class="half">
        <a class="logo" id="logox">
            <img id="bgl" src="HOME_IMG/logo_n.png">
        </a>
        <p>企业LOGO</p>
    </div>
    <div class="half">
        <div class="uploader blue">
            ...
            <a class="license">
                <img id="img-1" src="HOME_IMG/logo_n.png">
            </a>
...
<article class="info">
    <ul>
        ...
        <li>
            ...
            <div class="right">
                <input placeholder="例:028-88888888">
            </div>
            <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="right">
                <input placeholder="例:成都市锦江区塔子山一号">
            </div>
            <div class="clear"></div>
        </li>
        <li>
            ...
            <div class="right">
                <input placeholder="例:高端网站建设服务提供商">
            </div>
            <div class="clear"></div>
        </li>
        <li>
