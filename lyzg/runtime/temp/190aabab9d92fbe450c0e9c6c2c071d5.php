<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:95:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\public/../application/admin\view\consult\index.html";i:1518059472;s:83:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\application\admin\view\public\left.html";i:1518059472;s:85:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\application\admin\view\public\header.html";i:1518059472;s:85:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\application\admin\view\public\footer.html";i:1518059472;s:83:"D:\aliuyuhang\phpstudy\PHPTutorial\WWW\lyzg\application\admin\view\public\tool.html";i:1518059472;}*/ ?>
<html>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">来源</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">学校</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">班级</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">问题</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">答案</th>
                            ...
                            <tr>
                                <td><a href="<?php echo url('reply/reply'); ?>"><?php echo $vo['content_id']; ?></a></td>
                                ...
                                <td>
                                    <div id="picurl" class="layer-photos-demo">
                                        <img layer-pid="" layer-src="<?php echo $vo['picurl']; ?>" src="<?php echo $vo['picurl']; ?>" style="height: 40px;width: 40px;" alt="问题">
                                    </div>
                                ...
                                <td>
                                    <div id="answer"  class="layer-photos-demo">
                                        ...
                                        <img layer-pid="" layer-src="<?php echo $vo['answer']; ?>" src="<?php echo $vo['answer']; ?>" style="height: 40px;width: 40px;"alt="答案">
                                    </div>
                                </td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['time']); ?></td>
                                <td>
                                    <div class="layui-upload">
                                        <button type="button" class="btn btn-success" value="<?php echo $vo['content_id']; ?>"><i class="fa fa-send"></i>&nbsp;&nbsp;
...
layui.use('upload', function(){
    ...
    uploadInst = upload.render({
        elem: $('.btn-success')
        ,url: '<?php echo url("consult/ajax_pic"); ?>'
        ,before: function(obj){
            index = layer.load();
        }
        ,done: function(res){
