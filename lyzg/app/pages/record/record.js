...
Page({
  ...
  getAllTotal: function (taskID, startDay, endDay) {
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/findAll?type=daily&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
  ...
  //    wx.request({
  //      url: 'https://liuyuhang.xin/api/sign?type=all&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
  //     method: 'GET', 
  //     success: function(res){
  //       // success
  ...
  getSingleTotal: function (openId, taskID, startDay, endDay) {
    ...
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/getMyself?type=individual&detail=simple&openId=' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay,
      method: 'GET',
      success: function(res){
        // success
        var d = res.data.data;
  ...
  getSingleRecord: function (openId, taskID, startDay, endDay, detail) {
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/getMyplan?type=individual&openId=' + openId + '&taskID=' + taskID + '&startDate=' + startDay + '&endDate='+ endDay + '&detail=' + detail,
      method: 'GET',
      success: function(res){
        // success
        var d = res.data.data;
