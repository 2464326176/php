...
Page({
  ...
  updateTask: function (openId) {
    var that = this;
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/plan_list',
      data: {
        openId: openId 
      },
      method: 'GET', 
      success: function(res){
        ...
        console.log('尚未参加或者创立计划')
          ...
          //       "signedNum": res.data.signedNum,
          //       "signstate": res.data.plansign[0].signstate
          //     }
          //     var json_tasks=that.mergeJsonObject(signstate, tasks[i]);
          //     tmpTasks.push(json_tasks);
              
          //   if (res.data.plansign[0].signstate == 3) {
          //     tasks[i].disTime = Math.floor(disTime / (3600 * 1000 * 24))
          //   }
          // }
          }
  ...
  // 删除任务
    ...
    var deleteUrl = 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/plan_delete';
    var that = this;
