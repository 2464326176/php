...
Page({
  ...
  createTask: function () {
    ...
    wx.request({
      url: 'https://liuyuhang.xin/lyzg/public/index.php/wxapi/plan/getplan',
      data: {
        name: task.name,
        address: task.address,
  ...
  bindSubmit: function (e) {
    ...
    if (task.name == '' || task.address == '点击选择地点' || task.content == '' ) {
      this.setData({
        modalHidden: false
      });
    } else {
